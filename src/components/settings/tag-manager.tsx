...
// Muted, desaturated palette to match the rest of the app's
// professional look (not the default saturated rainbow).
const PRESET_COLORS = [
  { name: 'Slate', value: '#6b7280' },
  { name: 'Blue', value: '#6b7a99' },
  { name: 'Teal', value: '#6f9488' },
  { name: 'Green', value: '#5f9e78' },
  { name: 'Olive', value: '#8a9a5e' },
  { name: 'Gold', value: '#b0905c' },
  { name: 'Clay', value: '#b07f5c' },
  { name: 'Mauve', value: '#8b7596' },
];
