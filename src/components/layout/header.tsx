...
export function Header({ onOpenSidebar }: HeaderProps) {
  ...
  // Ad Studio runs on a premium dark canvas — flip the header's surface tokens
  // dark so the chrome is edge-to-edge with the studio.
  const isStudio = pathname.startsWith("/ad-studio");
