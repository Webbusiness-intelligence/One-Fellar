...
// Playfair Display drives the Kimi look's display headings (--font-heading).
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className={`${interSans.variable} ${playfair.variable} ${geistMono.variable} h-full antialiased`}
