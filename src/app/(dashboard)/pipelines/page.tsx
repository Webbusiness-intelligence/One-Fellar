...
const SPEC_DEFAULT_STAGES = [
  { name: "New Lead", color: "#6b7a99", position: 0 }, // dusty blue
  { name: "Qualified", color: "#6f9488", position: 1 }, // sage
  { name: "Proposal Sent", color: "#b0905c", position: 2 }, // muted gold
  { name: "Negotiation", color: "#8b7596", position: 3 }, // mauve
  { name: "Won", color: "#5f9e78", position: 4 }, // muted green
];
