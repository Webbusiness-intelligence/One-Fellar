...
const nextConfig: NextConfig = {
  // sharp is a native module — keep it external so the bundler doesn't try
  // to bundle its binaries. Used by the Ad Studio upload route to normalize
  // any product image to PNG.
